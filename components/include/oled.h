...
*/
//I2C
#define I2C_OLED_MASTER_SCL_IO          GPIO_NUM_9               /*!< gpio number for ESP32S2 I2C master clock */
#define I2C_OLED_MASTER_SDA_IO          GPIO_NUM_8               /*!< gpio number for ESP32S2 I2C master data  */
